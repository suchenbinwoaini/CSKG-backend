...
json_file = r'D:\github\基于计算机学科知识图谱的智能问答系统\CSKG-zzz\CSKG-backend\src\wordlist.json'
...
class Analyze(object):
    ...
    def load_data(self) -> None:
        ...
        # 加载意图特征库
        with open(f"D:\github\基于计算机学科知识图谱的智能问答系统\CSKG-zzz\CSKG-backend\src\intention.yaml", "r",
